...
from botron.tools.contracts.slither import ingest_slither_file
from botron.tools.research import cve as cve_mod
from botron.tools.research import fuzz as fuzz_mod
from botron.tools.research.chain import critical_path_score, plan_chains, promote_chain
...
from botron.tools.research.health import backend_health
from botron.tools.research.patch import PATCH_TOOLS
from botron.tools.research.sarif import ingest_sarif_file
from botron.tools.research.scanner_tools import SCANNER_TOOLS
from botron.tools.reversing.binary import identify_binary
from botron.tools.reversing.packer import detect_packer
from botron.tools.reversing.strings import extract_strings, group_by_category
from botron.tools.reversing.symbols import summarize_symbols
from botron.tools.web.jwt import parse_token
from botron.tools.web.oauth import analyze_oauth_callback
from botron.tools.web.session import analyze_cookie
...
from botron.tools.research._state import (  # noqa: E402
    _json,
    _kg_backend_name,
    _load,
    _save,
...
async def validate_finding(
    ...
    """
    from botron.tools.bash.bash import get_sandbox
