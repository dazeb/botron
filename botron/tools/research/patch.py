...
stage-3 :func:`~botron.research.tools.validate_finding` used) inside
the same sandbox via :func:`botron.research.poc.sandbox_runner`. If
...
from botron.tools.research._state import _json, _load, _save
from botron.tools.research.graph import Edge, EdgeKind, Node, NodeKind, Severity
from botron.tools.research.poc import sandbox_runner
