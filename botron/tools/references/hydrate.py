...
``botron/references/`` knows how to parse. Safe to call multiple
times — ``ensure_cached`` does a fast-forward pull when the clone is
already present.

Usage::

    from botron.tools.references.hydrate import hydrate_all
    hydrate_all()

or as a one-liner::

    python -m botron.references.hydrate
...
from botron.tools.references.cve_poc_index import (
    MRXN_SLUG,
    TRICKEST_SLUG,
    build_index,
    invalidate_cache,
...
from botron.tools.references.fetch import ReferenceCache, ensure_cached
from botron.tools.references.h1_corpus import invalidate_corpus_cache
from botron.tools.references.killchain import invalidate_entries_cache
from botron.tools.references.methodology import invalidate_chapters_cache
from botron.tools.references.oneliners import invalidate_recipes_cache
from botron.tools.references.payloads_ingest import invalidate_merged_cache
