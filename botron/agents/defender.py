...
from botron.backends import DockerDefenseBackend, DockerSandbox
...
from botron.tools.defense import set_defense_backend
...
from botron.tools.research.tools import kg_neighbors, kg_query, kg_stats
...
def create_defender_agent():
    ...
    In production, point BOTRON_DOCKER__SANDBOX_CONTAINER_NAME (or a dedicated
    ...
    # not the offensive sandbox. Override BOTRON_DOCKER__SANDBOX_CONTAINER_NAME
