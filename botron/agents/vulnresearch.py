...
Mirrors :mod:`botron.agents.botron` (the red-team orchestrator)
...
from botron.middleware import OPPLANMiddleware
from botron.middleware.skills import DecepticonSkillsMiddleware
from botron.tools.research.tools import kg_query, kg_stats
